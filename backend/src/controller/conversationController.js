...
export const createConversation = async (req, res) => {
  try {
    ...
    if (
      ...
      return res
        .status(400)
        .json({ message: "Group name and member list are required" , success: false, error: true });
    }
    ...
    if (!conversation) {
      return res.status(400).json({ message: "Invalid conversation type", success: false, error: true });
    }
